...
from datasets import prepare_ninapro, prepare_dataframe_dataset, SequenceDataModule, SequenceDataset, AbstractDataset
from definitions import PKL_FOLDER


class NinaProDataModule(SequenceDataModule):
    def __init__(self,
