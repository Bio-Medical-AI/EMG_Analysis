...
from datasets import DerivativeDataset
...
def main():
    ...
    classifier_params = {'num_classes': data_module_myoarmband.num_classes,
                         'input_width': series_length,
                         'input_height': data_module_myoarmband.width * data_module_myoarmband.height,
                         'channels': 2}
    ...
    classifier_params = {'num_classes': data_module_ninapro.num_classes,
                         'input_width': series_length,
                         'input_height': data_module_ninapro.width * data_module_ninapro.height,
                         'channels': 2}
